package com.ironhack.crudbankapp.security;

import com.ironhack.crudbankapp.filters.AuthenticationFilter;
import com.ironhack.crudbankapp.filters.AuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        AuthenticationFilter customAuthenticationFilter = new AuthenticationFilter(authManagerBuilder.getOrBuild());
